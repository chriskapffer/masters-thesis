...
#pragma mark other
    ...
    void utils::movePoints(vector<Point2f>& points, const Point2f& offset)
    {
    ...
    float utils::averageDistance(const vector<Point2f>& points1, const vector<Point2f>& points2)
    {
...
#pragma mark conversion
    ...
    void utils::get2DCoordinatesOfKeyPoints(const vector<KeyPoint>& keypoints, std::vector<cv::Point2f>& coordinates, const Point2f& offset)
    {
    ...
    void utils::get2DCoordinatesOfMatches(const vector<DMatch>& matches, const vector<KeyPoint>& keypoints1, const vector<KeyPoint>& keypoints2, vector<Point2f>& coordinates1, vector<Point2f>& coordinates2, const Point2f& offset1, const Point2f& offset2)
    {
