...
def put_framework_together(srcroot, dstroot):
    ...
    currdir = os.getcwd()
    framework_dir = dstroot + "/opencv2fast.framework"
    ...
    os.system("lipo -create " + wlist + " -o " + dstdir + "/opencv2fast")
    ...
    # make symbolic links ?opencv2fast?
    os.symlink(dstdir + "/Headers", "Headers")
    os.symlink(dstdir + "/Resources", "Resources")
    os.symlink(dstdir + "/opencv2fast", "opencv2fast")
